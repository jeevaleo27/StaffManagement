	...
	<div class="row grow w-99.8">	
        <div id="form" class="main col-12 h-100 py-2">			
			<table id="example" class="table table-bordered table-sm display nowrap" >
				<thead>
					<tr>  
						<button type='button' class='btn btn-primary  btn-sm edit'><a href="<?php echo base_url('MaritalStatus/InsertMaritalStatusDetails')?>" style='color:white;'>Create_MaritalStatus_Details</a>
						</button>
	 ...
	 <!-- The Modal -->
  	<div class="modal fade" id="ShowMaritalStatusDetails">
      	...
      	<div class="modal-content">
        	...
        	<div class="modal-body">
         		<div class="form-group form-group-sm">
              	<label  class="col-sm-2 control-label" for="MaritalStatusName">MaritalStatusName*</label> <br>
              	<input type="text" name="MaritalStatusName"id="MaritalStatusName" > 
         		</div>
...
<script>
    ...
    $(document).ready(function() 
    {
	            $.ajax
	            ({
		            url: "<?php echo base_url("MaritalStatus/ViewmMaritalStatus");?>",
		            type: "POST",
		            cache: false,
     			...
     			{ 
		            ...
		            $.ajax({
			                  url: "<?php echo base_url("MaritalStatus/DeleteMaritalStatus");?>",
			                  type: "POST",
			                  cache: false,
			                  data: {
				                  		type: 2,
				                  		MaritalStatusUID: $(this).attr("data-id")
			                      	},
			                       success: function(dataResult){
	            ...
	            $(function () {
                    $(document).on("click", "#MaritalStatusDetails", function(event) { 
               			var MaritalStatusUID = $(this).attr('data-MaritalStatusUID');
               			var MaritalStatusName = $(this).attr('data-MaritalStatusName');
               			var Active = $(this).attr('data-Active');
                		console.log(MaritalStatusName);
                		var modal = $('#ShowMaritalStatusDetails');
                		modal.find('#MaritalStatusName').val(MaritalStatusName);
