	...
	<div class="row grow w-99.8">	
        <div id="form" class="main col-12 h-100 py-2">			
			<table id="example" class="table table-bordered table-sm display nowrap" >
				<thead>
					<tr>  
						<button type='button' class='btn btn-primary  btn-sm edit'><a href="<?php echo base_url('ClassView/InsertClassDetails')?>" style='color:white;'>Create_Class_Details</a>
						</button>
							<th>ClassUID</th>
							<th>ClassName</th>
							<th>CreatedBy</th>
	 ...
	 <!-- The Modal -->
  	<div class="modal fade" id="ShowClassDetails">
      	...
      	<div class="modal-content">
        	...
        	<div class="modal-body">
         		<div class="form-group form-group-sm">
              	<label  class="col-sm-2 control-label" for="ClassName">ClassName*</label> <br>
...
<script>
    ...
    $(document).ready(function() 
    {
	            $.ajax
	            ({
		            url: "<?php echo base_url("ClassView/ViewmClass");?>",
		            type: "POST",
		            cache: false,
                ...
                var $ele = $(this).parent().parent();
		            ...
		            $.ajax({
			                  url: "<?php echo base_url("ClassView/DeleteClass");?>",
			                  type: "POST",
			                  cache: false,
			                  data: {
				                  		type: 2,      	
				                  		ClassUID: $(this).attr("data-id")
			                      	},
			                       success: function(dataResult){
	       ...
	       /* function to perform the modal function @author:Jeeva*/
	            $(function () {
     			 ...
     			 /* function to perform the modal function @author:Jeeva*/
	            $(function () {
	                    $(document).on("click", "#ClassDetails", function(event) { 
               			var ClassUID = $(this).attr('data-ClassUID');
               			var ClassName = $(this).attr('data-ClassName');
               			var Active = $(this).attr('data-Active');
                		console.log(ClassName);
                		var modal = $('#ShowClassDetails');
