	...
	<div class="row grow w-99.8">	
        <div id="form" class="main col-12 h-100 py-2">			
			<table id="example" class="table table-bordered table-sm display nowrap" >
				<thead>
					<tr>  
						<button type='button' class='btn btn-primary  btn-sm edit'><a href="<?php echo base_url('Qualification/InsertQualificationDetails')?>" style='color:white;'>Create_Qualification_Details</a>
						</button>
	 ...
	 <!-- The Modal -->
  	<div class="modal fade" id="ShowQualificationDetails">
      	...
      	<div class="modal-content">
        	...
        	<div class="modal-body">
         		<div class="form-group form-group-sm">
              	<label  class="col-sm-2 control-label" for="QualificationName">QualificationName*</label> <br>
              	<input type="text" name="QualificationName"id="QualificationName" > 
         		</div>
...
<script>
    ...
    $(document).ready(function() 
    {
	            $.ajax
	            ({
		            url: "<?php echo base_url("Qualification/ViewmQualification");?>",
		            type: "POST",
		            cache: false,
     			...
     			{ 
		            ...
		            $.ajax({
			                  url: "<?php echo base_url("Qualification/DeleteQualification");?>",
			                  type: "POST",
			                  cache: false,
			                  data: {
				                  		type: 2,
				                  		QualificationUID: $(this).attr("data-id")
			                      	},
			                       success: function(dataResult){
	            ...
	            $(function () {
                    $(document).on("click", "#QualificationDetails", function(event) { 
               			var QualificationUID = $(this).attr('data-QualificationUID');
               			var QualificationName = $(this).attr('data-QualificationName');
               			var Active = $(this).attr('data-Active');
                		console.log(QualificationName);
                		var modal = $('#ShowQualificationDetails');
                		modal.find('#QualificationName').val(QualificationName);
